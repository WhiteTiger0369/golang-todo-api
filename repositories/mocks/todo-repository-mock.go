...
// Source: repositories/todo-repository.go

// Package mocks is a generated GoMock package.
package mocks

import (
	common "ex1/todo-api/common"
	entities "ex1/todo-api/entities"
	reflect "reflect"
...
func (m *MockTodoRepository) Delete(id uint) {
	m.ctrl.T.Helper()
...
func (m *MockTodoRepository) FindAll() ([]entities.Todo, common.DatabaseError) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "FindAll")
	ret0, _ := ret[0].([]entities.Todo)
	ret1, _ := ret[1].(common.DatabaseError)
	return ret0, ret1
}
...
func (m *MockTodoRepository) FindByID(id uint) (entities.Todo, common.DatabaseError) {
	m.ctrl.T.Helper()
...
func (m *MockTodoRepository) FindByUserId(userId uint) ([]entities.Todo, common.DatabaseError) {
	m.ctrl.T.Helper()
...
func (mr *MockTodoRepositoryMockRecorder) FindByUserId(userId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "FindByUserId", reflect.TypeOf((*MockTodoRepository)(nil).FindByUserId), userId)
}

// Save mocks base method.
func (m *MockTodoRepository) Save(todo entities.Todo) (entities.Todo, common.DatabaseError) {
	m.ctrl.T.Helper()
